...
namespace Ceg\LoginAsCustomer\Controller\Adminhtml\Login;
...
class Login extends Action implements HttpGetActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        ( $customer->getStoreId() ) ?  $storeId = (int)$customer->getStoreId() : $storeId = (int)$this->storeManager->getDefaultStoreView()->getId();
