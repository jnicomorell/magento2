...
namespace Ceg\CustomerAddressAttributes\Model;
...
class ShippingInformationManagement extends \Magento\Checkout\Model\ShippingInformationManagement
{
     ...
     */
    protected $payMethodManagement;

    /**
     * @var PaymentDetailsFactory
     */
    protected $payDetailsFactory;
    ...
    /**
     * @param PaymentMethodManagementInterface $payMethodManagement
     * @param PaymentDetailsFactory $payDetailsFactory
    ...
    public function __construct(
        PaymentMethodManagementInterface $payMethodManagement,
        PaymentDetailsFactory $payDetailsFactory,
        ...
        $this->payMethodManagement = $payMethodManagement;
        $this->payDetailsFactory = $payDetailsFactory;
    ...
    public function saveAddressInformation(
        ...
        $address->setNumero($attributes->getNumero());
        $address->setColonia($attributes->getColonia());
        $address->setObservaciones($attributes->getObservaciones());
        ...
        try {
            ...
            if ($billingAddress) {
                ...
                $billingAddress->setExtensionAttributes($address->getExtensionAttributes());
                $billingAddress->setNumero($attributes->getNumero());
                $billingAddress->setColonia($attributes->getColonia());
                $billingAddress->setObservaciones($attributes->getObservaciones());
        ...
        $paymentDetails = $this->payDetailsFactory->create();
        $paymentDetails->setPaymentMethods($this->payMethodManagement->getList($cartId));
