<?php
namespace Formax\Campaigns\Model\Import;
 ...
 * Class Courses
 */
class Campaigns extends AbstractEntity
{
    const ENTITY_CODE = 'campaigns';
    const TABLE = 'formax_campaigns_campaign';
        ...
        while ($bunch = $this->_dataSourceModel->getNextBunch()) {
            ...
            foreach ($bunch as $rowNum => $row) {
                ...
                foreach ($this->getAvailableColumns() as $columnKey) {
                    if($columnKey=='rut'){
                        $columnValues[$columnKey] = str_replace(".","",$row[$columnKey]);
                        $columnValues[$columnKey] = str_replace("-","",$columnValues[$columnKey]);
                        $columnValues[$columnKey] = strtolower($columnValues[$columnKey]);
                    }else{
