require(['jquery', 'jquery-rut'], function($) {
    ...
    $(document).ready(function(){
        ...
        $('.solicitar_credito_cyber').click(function(e){
            e.preventDefault();

            let cuotas = $(this).attr('data-cuotas')
            let monto = $(this).attr('data-monto')
            let vcuota = $(this).attr('data-vcuota')
            let imensual = $(this).attr('data-imensual')
            let ianual = $(this).attr('data-ianual')
            let desgravamen = $(this).attr('data-desgravamen')
            let total = $(this).attr('data-total')
            let cae = $(this).attr('data-cae')
            $('.cuotas').val(cuotas)
            $('.monto').val(monto)
            $('.vcuota').val(vcuota)
            $('.imensual').val(imensual)
            $('.ianual').val(ianual)
            $('.desgravamen').val(desgravamen)
            $('.total').val(total)
            $('.cae').val(cae)
            ...
            $('input[name=comment]').val(`
                ...
                cuotas: ${cuotas}, 
                valor_cuouta: ${vcuota},
                interes_mensual: ${imensual},
                interes_anual: ${ianual},
