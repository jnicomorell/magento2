...
class InlineEdit extends \Magento\Backend\App\Action
{
        ...
        if ($this->getRequest()->getParam('isAjax')) {
            ...
            if (!count($postItems)) {
                ...
                foreach (array_keys($postItems) as $fileId) {
                    ...
                    $model = $this->_objectManager->create('Formax\UploadGeneral\Model\File');
                    $model->load($fileId);
                    try {
     ...
     * @return string
     */
    protected function getErrorWithFileId(\Formax\UploadGeneral\Model\File $file, $errorText)
    {
    ...
    {
        return $this->_authorization->isAllowed('Formax_UploadGeneral::file_create') ||
        $this->_authorization->isAllowed('Formax_UploadGeneral::file_update');
    }
}
