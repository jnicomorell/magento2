...
class FileUploader
{
    ...
    public function __construct(
        ...
        $baseTmpPath = 'UploadGeneral/tmp/file',
        $basePath = 'UploadGeneral/file',
        $allowedExtensions = ['pdf','html','jpg','js','css','json']
    ) {
     ...
     * @return void
     */
    public function deleteFile($fileName, $type = 'dir')
    {
        $basePath = $this->getBasePath();
        if ($type == 'tmp') {
        ...
        if ($this->getFileInfo()->isExist($fileName, $basePath)) {
            $this->getFileInfo()->deleteFile($fileName, $basePath);
        }
    }
}
