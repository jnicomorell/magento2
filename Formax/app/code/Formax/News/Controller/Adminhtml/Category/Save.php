...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Formax\News\Model\Category')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('Formax_News::category_update') || $this->_authorization->isAllowed('Formax_News::category_create');
    }
}
