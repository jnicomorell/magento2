...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu(
            ...
            __('Credit Card Campaigns'), __('Credit Card Campaigns')
        )->addBreadcrumb(
            __('Credit Card Campaigns'), __('Credit Card Campaigns')
        )->addBreadcrumb(
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Credit Card Campaigns'));
    ...
    {
        return $this->_authorization->isAllowed('Formax_Campaigns::credit_card_campaign_read') || $this->_authorization->isAllowed('Formax_Campaigns::credit_card_campaign_create');
    }
}
