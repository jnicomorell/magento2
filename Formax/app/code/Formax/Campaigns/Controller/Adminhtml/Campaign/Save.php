...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Formax\Campaigns\Model\Campaign')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('Formax_Campaigns::campaign_update') || $this->_authorization->isAllowed('Formax_Campaigns::campaign_create');
    }
}
