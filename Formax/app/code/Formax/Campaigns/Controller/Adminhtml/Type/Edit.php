...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Campaigns - Types'));
    ...
    {
        return $this->_authorization->isAllowed('Formax_Campaigns::type_read') || $this->_authorization->isAllowed('Formax_Campaigns::type_create');
    }
}
