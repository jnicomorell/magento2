...
class InlineEdit extends \Magento\Backend\App\Action
{
     ...
     * @return string
     */
    protected function getErrorWithTypeId(\Formax\Campaigns\Model\Type $type, $errorText)
    {
    ...
    {
        return $this->_authorization->isAllowed('Formax_Campaigns::type_create') ||
        $this->_authorization->isAllowed('Formax_Campaigns::type_update');
    }
}
